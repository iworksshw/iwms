...
exports.reset =  series(clear, guideCopy, commonCopy, compileCss, compileScss, compileEjs); //내부 파일을 임의로 추가,삭제,변경시 실행
exports.build = series(guideCopy, commonCopy, compileCss, compileScss, compileEjs);         //변경사항 적용
